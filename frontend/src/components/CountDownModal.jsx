...
import questionImage from "../assets/img/speed-question-box.svg";
import { useNavigate } from "react-router-dom"; // Correctly import useNavigate

const CountDownModal = ({ isOpen, onClose, fireIcon }) => {
  ...
  const copyToClipboard = () => {
    ...
    setTimeout(() => {
      ...
      // Redirect to countdown game page after 12 seconds in the waiting room
      setTimeout(() => {
        navigate("/countdowngamepage"); // Navigate to the countdown game page
